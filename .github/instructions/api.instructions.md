...
- `OpenWrtUbusWifiPresenceApiClientError` (Base)
- `OpenWrtUbusWifiPresenceApiClientCommunicationError` (Network, timeout, HTTP errors)
- `OpenWrtUbusWifiPresenceApiClientAuthenticationError` (401, 403, invalid credentials)
